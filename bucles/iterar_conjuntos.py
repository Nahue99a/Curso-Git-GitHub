...
for numero, animal in zip(animales, numeros):   #Forma de recorrer dos conjuntos al mismo tiempo con un for
...
for num in enumerate(numeros):  #Recorre una conjunto por su indice
    print(num)
